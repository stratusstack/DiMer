-- DiMer test fixture: Databricks side (source B / "target")
-- Apply in a Databricks SQL editor/notebook against $DATABRICKS_CATALOG.$DATABRICKS_SCHEMA
...
-- Row 9: only in Databricks -> ADDED (missing from Postgres)
INSERT INTO customers (id, name, email, amount, status, created_at) VALUES
...
-- Row 12: only in Databricks -> ADDED
INSERT INTO customers (id, name, email, amount, status, created_at) VALUES
