-- DiMer test fixture: YugabyteDB (YSQL) side (source B / "target")
-- YSQL is a PostgreSQL fork; apply with:
-- ysqlsh -h $YUGABYTE_HOST -p $YUGABYTE_PORT -U $YUGABYTE_USER -d $YUGABYTE_DATABASE -f yugabyte_customers.sql
...
-- Row 9: only in Yugabyte -> ADDED (missing from Postgres)
INSERT INTO customers (id, name, email, amount, status, created_at) VALUES
