-- DiMer test fixture: MySQL side (source B / "target")
-- Apply with: mysql -h $MYSQL_HOST -u $MYSQL_USER -p $MYSQL_DATABASE < mysql_customers.sql
...
-- Row 9: only in MySQL -> ADDED (missing from Postgres)
INSERT INTO customers (id, name, email, amount, status, created_at) VALUES
